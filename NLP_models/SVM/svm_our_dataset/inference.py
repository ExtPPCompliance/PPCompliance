...
if __name__=='__main__':
    ...
    # Inference
    infer_dataset=pd.read_csv('../liushuang_dataset.csv', encoding='utf-8')
    ...
    df_report.to_csv('our_liushuang_report_svm.csv',index=True)
    print(report)
    ...
    df_report = pd.DataFrame(report).transpose()
    df_report.to_csv('our_liushuang_report_nb.csv',index=True)
    print(report)
